...
const About = () => {
    return (
        <div className='flex flex-col w-3/5 z-10'>
            ...
            <p className='text-slate-400 my-2 text-xs md:text-sm lg:text-base'>Building efficient and accessible web applications.</p>
        </div>
    )
}
